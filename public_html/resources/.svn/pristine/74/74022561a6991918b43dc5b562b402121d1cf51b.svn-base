...
//******************************************************************************
    ...
    // EM 04-01-2009 var scwBaseYear        = scwDateNow.getFullYear();
    ...
    var scwDropDownYears   = 3; // 04-01-2009
   ...
   // var scwTodayCellBorderColour = 'red';
    ...
    var scwTodayCellBorderColour = 'yellow';
    ...
    document.writeln(
        '<style type="text/css">'                                       +
            ...
            '/* Calendar background */'                                 +
            'table.scw                  {background-color:  #F1F1F1;}'  +
            '/* Drag Handle */'                                         +
            'td.scwDrag                 {background-color:  #F1F1F1;'   +
                                        'color:             #CCCCFF;}'  +
            '/* Week number heading */'                                 +
            ...
            'td.scwCellsExMonth         {background-color:  #CCCCCC;'   +
                                        'color:             #666666;}'  +
            '/* Today selector */'                                      +
            'td.scwFoot                 {background-color:  #F1F1F1;'   +
                                        'color:             #444444;}'  +
